...
const UserCard = () => {
	...
	const { data: allUsers, loading, error } = useFetch('https://dummyjson.com/users');
		...
		<div className="container mx-auto mt-8 text-black">
			...
			<div className="flex items-center mb-4">
				...
				>
					...
					{[...new Set(allUsers.users.map((user) => user.address.city))].map((city) => (
			...
			<div className='grid grid-cols-3 gap-4'>
				{users.map((user, index) => (
					<div key={index} className={`bg-yellow-500 p-4 rounded shadow text-gray-800 mb-4`}>
						<div className="mb-4">
